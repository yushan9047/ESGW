...
class ControllerExtensionEventDBlogModule extends Controller
{
    ...
    public function view_common_column_left_before(&$route, &$data, &$output)
    {
		...
		$d_blog_module[] = array(
            'name'     => '平台系統管理',
            'href'     => $this->model_extension_d_opencart_patch_url->link('extension/d_blog_module/post&filter_category=8'),
            'children' => array()
        );
		
		$d_blog_module[] = array(
            'name'     => '最新消息管理',
            'href'     => $this->model_extension_d_opencart_patch_url->link('extension/d_blog_module/post&filter_category=9'),
            'children' => array()
        );
		
		$d_blog_module[] = array(
            'name'     => '網頁管理',
            'href'     => $this->model_extension_d_opencart_patch_url->link('extension/d_blog_module/post&filter_category=10'),
            'children' => array()
        );
